...
def evaluate_process(model, test_batches, train_epoch, best_link_f1=None, best_merge_f1=None, preview=False):
    ...
    for batch in test_batches:
        ...
        # print(f"SHAPE of pred link=={pred_link}")
        # print(f"SHAPE of target link=={target_link}")
    ...
    print(f"length of predictions = {len(all_predict_link_flatten)}")
    print(f"length of tragets = {len(all_target_link_flatten)}")
