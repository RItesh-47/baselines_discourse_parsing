...
map_relations = {}
data_train = load_data('/DATA1/ritesh/baselines_discourse_parsing/DialogueDiscourseParsing/data/Molweni/train.json', map_relations)
data_test = load_data('/DATA1/ritesh/baselines_discourse_parsing/DialogueDiscourseParsing/data/Molweni/test.json', map_relations)
